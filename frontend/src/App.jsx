...
export default function App() {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen">
      {/* Chat List - Full width on mobile, 1/4 on desktop */}
      <div className="w-full h-1/3 md:w-1/4 md:h-full">
        <ChatList 
          onSelectChat={setActiveChat} 
      ...
      <div className="flex flex-col flex-1 h-2/3 md:h-full">
        <div className="flex justify-between items-center p-3 sm:p-4 bg-gradient-to-r from-indigo-900 to-purple-800 border-b border-white border-opacity-20">
          <h1 className="text-lg sm:text-xl font-bold bg-gradient-to-r from-pink-400 to-indigo-400 bg-clip-text text-transparent">
            Chatbot
          </h1>
          <button
            onClick={signOut}
            className="px-3 py-1.5 sm:px-4 sm:py-2 bg-gradient-to-r from-red-500 to-pink-600 rounded-xl hover:from-red-600 hover:to-pink-700 transition-all duration-200 shadow-lg hover:shadow-red-500/20 flex items-center space-x-2 text-sm sm:text-base"
          >
            <svg 
              xmlns="http://www.w3.org/2000/svg" 
